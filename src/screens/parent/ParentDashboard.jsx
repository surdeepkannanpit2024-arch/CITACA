    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="max-w-md mx-auto px-4 py-6">
        ...
        <div className="bg-blue-50 rounded-xl p-6 border-2 border-blue-200">
          <h3 className="font-bold text-blue-900 mb-2">👨‍👩‍👧 Parental Monitoring</h3>
          <p className="text-sm text-blue-800">Track your child's academic progress, attendance, and performance in one place.</p>
